<div style="margin:120px;">
  ...
  <form method = "post">
    ...
    <div style="border: 1px solid #c0c0c0; margin: 15px 30px 30px 0px; padding:15px; border-radius:10px 10px; background-color:white;">
      <b>重要度</b>
      <div class="rateit1" data-rateit-resetable="false"  data-rateit-ispreset="true" data-rateit-min="0" data-rateit-max="3" data-rateit-step="1" data-id="<?php echo $i;?>"></div>
      ...
      <input type="hidden" name="rank" id="rank-<?php echo $i;?>" value="">
    </div>
  <?php endfor;?>
</div>
