  ...
  <form method = "post">
    ...
    <div style="border: 1px solid #c0c0c0; padding:15px; border-radius:10px 10px; width:75%; margin:auto; background:white; margin-bottom:3%;">
      <div style="height:60px;">
        ...
        <input type="text" style="margin-right: 30%; width:220%;" placeholder="英単語" name="data[<?php echo $i; ?>][Word][word]">
        </div>
        <textarea placeholder="memo" cols="80" style="height:60px; width:70%; border:1px #c0c0c0 solid; resize:none; float:right;" name="data[<?php echo $i;?>][UserWord][comment]"></textarea>
      </div>
    </div>
  <?php endfor;?>
</div>
